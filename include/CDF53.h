...
class CDF53 {
 ...
 private:
  ...
  //
  void QccWAVCDF53AnalysisSymmetricEvenEven(double* signal, size_t signal_length);
  void QccWAVCDF53AnalysisSymmetricOddEven(double* signal, size_t signal_length);
  void QccWAVCDF53SynthesisSymmetricEvenEven(double* signal, size_t signal_length);
  void QccWAVCDF53SynthesisSymmetricOddEven(double* signal, size_t signal_length);
